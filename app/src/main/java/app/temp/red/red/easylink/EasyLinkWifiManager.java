package app.temp.red.red.easylink;
...
public class EasyLinkWifiManager 
{
	...
	/**
	 * Returns the current GatewayIP address connected to    网段ip
	 * @return
	 */
	public String getGatewayIpAddress()
	{
		int gatwayVal=	mWifiManager.getDhcpInfo().gateway;
		String s=(String.format("%d.%d.%d.%d", (gatwayVal & 0xff), (gatwayVal >> 8 & 0xff), (gatwayVal >> 16 & 0xff), (gatwayVal >> 24 & 0xff))).toString();
		return s;
	}

	public String getGatewayIpFirstThree()
	{
		int gatwayVal=	mWifiManager.getDhcpInfo().gateway;
		return (String.format("%d.%d.%d", (gatwayVal & 0xff), (gatwayVal >> 8 & 0xff), (gatwayVal >> 16 & 0xff))).toString();
	}
