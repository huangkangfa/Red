package in.srain.cube.views.ptr2;
...
import in.srain.cube.views.ptr2.util.PtrCLog;
 ...
 * It defines {@link in.srain.cube.views.ptr2.PtrUIHandler}, which allows you customize the UI easily.
 */
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!canMoveUp && !canMoveDown) {
                    ...
                    if(getMode()==Mode.REFRESH||getMode()==Mode.BOTH){
                    ...
                    if (getMode()==Mode.LOAD_MORE||getMode()==Mode.BOTH) {
